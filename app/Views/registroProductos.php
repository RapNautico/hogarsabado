        ...
        <div class="container mb-5">
             <div class="row mt-5 d-flex justify-content-center">
                <div class="col-12 col-md-5">
                    <h3 class="fuente2 fw-bold text-center text-1">Registro de productos</h3>
                    
                    <form id="waterform" action="<?= site_url('/productos/registro/nuevo') ?>" method="POST" class="mt-4">
				...
				<div class="d-grid gap-2 top">
					<a href="<?= site_url('/productos/listado') ?>" class="btn btn-perso top">Ver inventario</a>
        		</div>
	</div>
        </div>
