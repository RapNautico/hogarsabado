        ...
        <div class="container mt-5">
            <div class="row row-cols-1 row-cols-md-5 g-4">
                <?php foreach($animales as $animal): ?>
                    <div class="col">
                        <div class="card h-100 p-3 tarjeta">
                            ...
                            <div class="card-body">
                                ...
                                <div class="center">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#editar<?=$animal["id"]?>" href="#" class="btn btn-item center"><i class="fas fa-edit"></i></a>    
    
                                    <a data-bs-toggle="modal" data-bs-target="#confirmacion<?=$animal["id"]?>"  href="#" class="btn btn-itemred center"><i class="fas fa-trash-alt"></i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?= site_url('animales/eliminar/'.$animal["id"])?>" class="btn btn-itemred">Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <form action="<?= site_url('/animales/editar/'.$animal["id"]) ?>" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-item">Editar</button>
                                                    </form>
