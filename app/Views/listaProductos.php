                        ...
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="center">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#editar<?=$producto["id"]?>" href="#" class="btn btn-item center"><i class="fas fa-edit"></i></a>    
    
                                    <a data-bs-toggle="modal" data-bs-target="#confirmacion<?=$producto["id"]?>"  href="#" class="btn btn-itemred center"><i class="fas fa-trash-alt"></i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?= site_url('/productos/eliminar/'.$producto["id"])?>" class="btn btn-itemred">Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
