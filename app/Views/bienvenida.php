					...
					<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="<?= base_url('public/img/principal1.1.png')?>" class="d-block w-100 h-200" alt="co1">
							</div>
							<div class="carousel-item">
								<img src="<?= base_url('public/img/principal1.2.jpg')?>" class="d-block w-100 h-200" alt="co2">
							</div>
							<div class="carousel-item">
								<img src="<?= base_url('public/img/principal1.3.png')?>" class="d-block w-100 h-200" alt="co3">
							</div>
						</div>
